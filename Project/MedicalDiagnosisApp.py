...
background_image_url = "https://img.freepik.com/free-vector/clean-medical-background_53876-97927.jpg"
page_bg_img = f"""
<style>
...
width: 100%;
height: 100%;
background-color: rgba(0.3, 0.2, 0, 0.0);
}}
</style>
"""
...
models = {
    ...
    'heart_disease': pickle.load(open('Models/Heart_Disease_Prediction.sav', 'rb')),
    'parkinsons': pickle.load(open('Models/Parkinson_Disease_Prediction.sav', 'rb')),
    'lung_cancer': pickle.load(open('Models/Lung_Cancer_Prediction.sav', 'rb')),
    'thyroid': pickle.load(open('Models/Thyroid_Disease_Prediction.sav', 'rb'))
}
